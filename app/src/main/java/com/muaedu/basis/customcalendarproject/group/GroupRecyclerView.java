package com.muaedu.basis.customcalendarproject.group;
...
import com.muaedu.basis.customcalendarproject.R;
...
public class GroupRecyclerView extends RecyclerView {
    ...
    public GroupRecyclerView(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextSize = array.getDimensionPixelSize(R.styleable.GroupRecyclerView_group_text_size, 15);
        mGroupHeight = (int) array.getDimension(R.styleable.GroupRecyclerView_group_height, 50);
        mChildItemOffset = (int) array.getDimension(R.styleable.GroupRecyclerView_group_child_offset, 18);
        ...
        mPaddingLeft = (int) array.getDimension(R.styleable.GroupRecyclerView_group_padding_left, 15);
        mPaddingRight = (int) array.getDimension(R.styleable.GroupRecyclerView_group_padding_right, 15);
        array.recycle();
    }
