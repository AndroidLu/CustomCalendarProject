...
import com.muaedu.basis.customcalendarproject.adapter.BaseRecyclerAdapter;
...
final class YearAdapter extends BaseRecyclerAdapter<Month> {
    ...
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, Month item, int position) {
